...
urlpatterns = [
    ...
    path("upload-seller-profile-picture/<int:pk>/", views.upload_seller_profile_picture,
         name="upload_seller_profile_picture"),
path("upload-profile-picture/<int:pk>/", views.upload_profile_picture,
