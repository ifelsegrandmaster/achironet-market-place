        ...
        response = self.client.post(reverse("shop:contact"),
                                    {
                                        ...
                                        'email': 'info@agara.com',
                                        'subject': 'Hello world',
                                        'message': 'I am hello worlding'
                                    })
