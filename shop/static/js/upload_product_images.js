...
$(function() {
    ...
    $("#formUpload").submit(function(e) {
        ...
        $.ajax({
            url: `${ACHIRONET_PROTOCOL}://${ACHIRONET_HOSTNAME}/sell/products/upload-image/`,
            type: 'post',
            data: fd,
            headers: {
    ...
    //form upload
    $("#formDeleteImages").submit(function(e) {
        e.preventDefault();
        $form = $(this)
        var fd = new FormData(this);
        $.ajax({
            url: `${ACHIRONET_PROTOCOL}://${ACHIRONET_HOSTNAME}/sell/products/delete-images/`,
            type: 'post',
            data: fd,
            headers: {
                'X-CSRFToken': csrftoken
