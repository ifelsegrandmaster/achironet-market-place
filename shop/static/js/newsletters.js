...
function deleteNewsletter(button) {
    // get the newsletter id
    id = parseInt(button.dataset.newsletter)
    postData(`${ACHIRONET_PROTOCOL}://${ACHIRONET_HOSTNAME}/admin-dashboard/delete-newsletter/`, {
            email_newsletter_id: id
        })
        .then(data => {
